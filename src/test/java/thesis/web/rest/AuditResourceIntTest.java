...
import thesis.KotlinsterApp;
import thesis.config.audit.AuditEventConverter;
import thesis.domain.PersistentAuditEvent;
import thesis.repository.PersistenceAuditEventRepository;
import thesis.service.AuditEventService;
...
@SpringBootTest(classes = KotlinsterApp.class)
@Transactional
